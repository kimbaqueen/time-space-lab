...
// ANSWER: loop limits to 4, most efficient.
...
// 7) -------------------------------------------------------
let numberss = [76, 35, 73, 13, 4, 88, 23, 12, 86, 1, 54, 9, 10, 2]
// remember numbers could be reassigned, added to, etc.
let newNumbersA = numberss.filter((num) => {
  return num < 5
})
...
let newNumbersB = numberss.map((num) => {
  return num * 3
})
...
// ANSWER: I like the readability of the code above and would keep it.
...
// ANSWER: there is a defined object in the string that is always constant. 
// Each function is dependent on the data in the string making it O(n).
